        ...
        <div className="container">
          <div className="about-content">
            <div className="about-text">
              ...
              <p>
                Також у каталозі — ліпнина <strong>ELITE DECOR</strong> з колекцій Gaudi Decor і Grand
                Decor: карнизи, молдинги, плінтуси, розетки та 3D-панелі з поліуретану. Широкий вибір
                профілів для класичних і сучасних інтер'єрів за доступними цінами.
              </p>
              <ul className="features-list">
                <li>✓ Офіційний дилер OIKOS, ORAC DECOR та ELITE DECOR</li>
